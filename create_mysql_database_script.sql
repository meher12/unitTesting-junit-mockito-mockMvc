...
INSERT INTO `student` VALUES 
	(1,'David','Adams','david@guru2test.com'),
	(2,'John','Doe','john@guru2test.com'),
	(3,'Ajay','Rao','ajay@guru2test.com'),
	(4,'Mary','Public','mary@guru2test.com'),
	(5,'Maxwell','Dixon','max@guru2test.com');
